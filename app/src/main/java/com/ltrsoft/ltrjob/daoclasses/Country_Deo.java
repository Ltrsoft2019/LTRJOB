...
public class Country_Deo {
    ...
    public void getCountry(String country_id,Context context, UserCallBack userCallBack){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, ReadAll_URL,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                HashMap<String,String> map=new HashMap<>();
                map.put("user_id",country.getCountry_id());
                return map;
            }
        };
        RequestQueue requestQueue = Volley.newRequestQueue(context);
    ...
    public void updateCity(Country country,String country_id,Context context, UserCallBack userCallBack){
    ...
    public void deleteCity(Country country,String country_id,Context context, UserCallBack userCallBack){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Delete_URL,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("country_id",country.getCountry_id());
    ...
    public void searchCity(Country country,String country_id,Context context, UserCallBack userCallBack){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Delete_URL,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
