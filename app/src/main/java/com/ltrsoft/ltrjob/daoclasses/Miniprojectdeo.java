...
//
    ...
    public void fatchproject( Mini_Project miniProject1 ,String userid,Context context) {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for (int i = 0; i < json.length(); i++) {
                        ...
                        Mini_Project miniProject1 = new Mini_Project(mini_project_title, mini_project_start_date, mini_project_end_date, mini_project_topic, mini_project_technologies_used);
...
//                Toast.makeText(context, "Error: " + error, Toast.LENGTH_SHORT).show();
    ...
    public void updateproject(Mini_Project miniProject, String userid, Context context, UserCallBack callBack){
    ...
    public void deleteproject( Mini_Project miniProject,String userid,Context context,UserCallBack callBack){
