...
public class Workshop_Type {
    private int id;
    private String workshop_type_name,workshop_type_id;

    public Workshop_Type(int id, String workshop_type_id, String workshop_type_name) {
        this.id = id;
        this.workshop_type_id = workshop_type_id;
        this.workshop_type_name = workshop_type_name;
    }

    public Workshop_Type(String workshopTypeName) {
        this.workshop_type_name = workshop_type_name;
    }
