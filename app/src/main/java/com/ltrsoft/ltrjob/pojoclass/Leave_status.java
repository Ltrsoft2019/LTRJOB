...
public class Leave_status {
    private int id;
    private String leave_status_name,leave_status_id;

    public Leave_status(int id, String leave_status_id, String leave_status_name) {
        this.id = id;
        this.leave_status_id = leave_status_id;
        this.leave_status_name = leave_status_name;
    }

    public Leave_status(String leaveStatusName) {
        this.leave_status_name = leave_status_name;
    }
    ...
    public void setLeave_status_id(String leave_status_id) {
        this.leave_status_id = leave_status_id;
    }
