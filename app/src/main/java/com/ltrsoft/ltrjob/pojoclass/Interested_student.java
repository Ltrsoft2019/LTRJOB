...
{
    private int id,interested_student_id;
    private String interested_student_name,interested_student_class,interested_student_passing_year,interested_student_college,interested_student_course,interested_student_mobile;

    public Interested_student(int id, int interested_student_id, String interested_student_name, String interested_student_class, String interested_student_passing_year, String interested_student_college, String interested_student_course, String interested_student_mobile) {
        this.id = id;
    ...
    public int getInterested_student_id() {
        return interested_student_id;
    }

    public void setInterested_student_id(int interested_student_id) {
        this.interested_student_id = interested_student_id;
    }
