...
public class Batch {
    private int id, batch_id,user_id;
    private String batch_name,batch_time,batch_start_date,batch_end_date,one_time_fees,fees_with_installmaent;

    public Batch(int id, int batch_id, int user_id, String batch_name, String batch_time, String batch_start_date, String batch_end_date, String one_time_fees, String fees_with_installmaent) {
        this.id = id;
