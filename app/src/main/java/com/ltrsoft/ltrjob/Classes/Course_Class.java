...
public class Course_Class {
    public String course_id,course_name,course_duration,course_description,fees,course_image,course_feature;

    public Course_Class() {
    }

    public Course_Class(String course_id,String course_name, String course_duration, String course_description, String fees, String course_image, String course_feature) {
