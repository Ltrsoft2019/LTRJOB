...
public class Patent_Class {
    String patent_number, patent_type_id, patent_name, patent_decipline_id, patent_granted_year,
            patent_valid_till_year, patent_country_id, user_id;
